# from forms import CreateUser, CreateDoctor, CreatePatient, CreatePublicServant, CreateCountry, CreateDiseaseType, CreateSpecialist, CreatePatientDisease, CreateDisease, Add_discover
import urllib.parse
